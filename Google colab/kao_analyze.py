...
def kao_analyze(Total_y,train_X,train_y,test_X,test_y,target_spread,
    ...
    os.chdir('/content/drive/MyDrive/Colab Notebooks/0050專案分析_kaonthu/kao_stock_model')
    ...
    #    plt.figure(figsize = (12,4)) # 全部的資料 4616
    ...
    return {'T_para':GRU_spread.count_params(),
            'train_loss_1':round(train_loss_1,8),
            'test_loss_1':round(test_loss_1,8),
            'train_loss_2':round(train_loss_2,8),
            'test_loss_2':round(test_loss_2,8),

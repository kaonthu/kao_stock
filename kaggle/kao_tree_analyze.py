...
def kao_tree_data(target_spread,train_X,train_y,test_X,test_y,Total_y,out_train_all,train_predictions_frame,percent):
    ...
    print('0:優質點,1:劣質點',tree_data.groupby('tree_data_dis_type').size())
...
def kao_tree_stock_data(stock_sets,target_spread,train_X,train_y,test_X,test_y,Total_y,out_train_all,train_predictions_frame,percent,factor=[]):
    ...
    tree_data_stock['tree_data_dis_weight'][tree_data_stock['dis_type']==0] = tree_data_stock['dis'][tree_data_stock['dis_type']==0].rank(ascending=False)/sum(tree_data_stock['dis_type']==0)
    tree_data_stock['tree_data_dis_weight'][tree_data_stock['dis_type']==1] = tree_data_stock['dis'][tree_data_stock['dis_type']==1].rank()/sum(tree_data_stock['dis_type']==1)
